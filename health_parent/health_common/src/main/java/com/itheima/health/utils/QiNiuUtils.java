...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "A7g5ZQl2xMM8ZlPexvdLWNH8vjx-cQQv1Z0GQEzY";
    private static final String SECRETKEY = "mVkN0_baH-quQJ3OEwtAdfJGoRxjRnFFaf4Oylw6";
    private static final String BUCKET = "mytestyun";
    public static final String DOMAIN= "http://qmnr9zikt.hn-bkt.clouddn.com/";
